...
GEMINI_API_KEY = "AIzaSyC2ToC0lHBqU3flmRlkggqXhmhSZiibSGo"
...
- Recommended user actions"""
    ...
    try:
        ...
        if phishing_result['prediction_label'] == 1 or risk_level == "High" or verdict in ["SUSPICIOUS", "HIGHLY SUSPICIOUS"]:
...
with st.sidebar:
    ...
    3. Custom Phishing Detection Model
